...
namespace Jocasta.Services
{
    public class CartService : BaseService
    {
        ...
        {
            string query = "INSERT INTO [dbo].[cart] ([CartId],[UserId],[TotalQuantity],[TotalPrice]) " +
                "VALUES (@CartId,@UserId,@TotalQuantity,@TotalPrice)";
        ...
        {
            string query = "INSERT INTO [dbo].[cart_detail] ([CartDetailId],[CartId],[RoomCategoryId],[Quantity],[CheckIn],[CheckOut])" +
                " VALUES (@CartDetailId,@CartId,@RoomCategoryId,@Quantity,@CheckIn,@CheckOut)";
